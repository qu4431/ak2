...
```
> У лабораторній роботі було використано не GNU/Linux, а MacOS, тому команди відрізняються від звичайних, а також історія поділена на дві частини, залежно від користувача.
